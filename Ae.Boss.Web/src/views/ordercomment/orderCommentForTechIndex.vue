        ...
        >
          <template v-slot:condition>
            ...
            <el-form-item prop="techName">
              <el-input v-model="condition.techName" clearable placeholder="请输入技师名称或编号" />
            </el-form-item>
            <el-form-item prop="techLevel">
              <el-select v-model="condition.techLevel" clearable filterable placeholder="请选择技师级别">
                <el-option
              ...
              <template slot-scope="props">
                <el-form label-position="left" inline class="demo-table-expand">
                  ...
                  <el-form-item label="技师级别">
                    <span>{{ props.row.techLevelStr }}</span>
                  </el-form-item>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      appSvc
        .getOrderCommentForTechList(this.condition)
        .then(
          res => {
            var data = res.data;
