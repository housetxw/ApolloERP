        ...
        <section>
          <el-form :model="installguideModel" ref="installguideModel" :rules="guiderules"  label-width="80px"> 
            <el-form-item label="标题" prop="title"   >
              <el-input clearable placeholder="请输入标题" v-model="installguideModel.title" style="width:60%" size="mini"> </el-input>
            </el-form-item>
          ...
          <div slot="footer" class="dialog-footer" style="margin-top:10px;margin-left:300px;">
            <el-button @click="guidecancle()">取消</el-button>
  ...
  methods: {
    ...
    guidesave() {
      ...
      if (this.fileList.length > 0) {
        this.installguideModel.fileList = this.fileList;
      }
      appSvc
        .createInstallGuide(this.installguideModel)
        .then(
          res => {
            this.installguideModel = JSON.parse(
              JSON.stringify(this.installguideModelInit)
