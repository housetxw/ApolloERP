  ...
  <main class="container" >
          ...
          <el-tabs type="border-card" v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="保养" name="baoyang">
              ...
              >
                <el-table-column type="expand">
                  <template slot-scope="props">
                    <el-table
                      ...
                      style="width: 100%"
                    >
                      <el-table-column label="订单子单号" prop="orderProductId" align="center"></el-table-column>
                      ...
                      <el-table-column label="任务状态" prop="taskStatus" align="center"></el-table-column>
                      <el-table-column label="主人" prop="taskOwner" align="center"></el-table-column>
                      <el-table-column label="分配时间" prop="allocationTime" align="center">
                ...
                <el-table-column label="订单类型" prop="orderType" align="center"></el-table-column>
                <el-table-column label="订单渠道" prop="orderChannel" align="center"></el-table-column>
                <el-table-column label="仓库" prop="warehouseName" align="center"></el-table-column>

                <el-table-column label="用户名" prop="userName" align="center"></el-table-column>
                <el-table-column label="区域" prop="regionName" width="150" align="center"></el-table-column>
                <el-table-column label="下单时间" prop="orderDatetime"  width="150" align="center"></el-table-column>
    ...
    <section id="beginPurchaseOrder">
      <rg-dialog
        ...
        v-if="beginPurchaseOrderFormVisible"
        :beforeClose="beginPurchaseOrderCancel"
        :btnCancel="{label:'关闭',click:(done)=>{beginPurchaseOrderCancel('formModel')}}"
        :btnRemove="false"
        :footbar="true"
        width="78%"
        maxWidth="800px"
      ...
      >
        ...
        <template v-slot:footer>
          <el-button type="warning" @click="beginPurchaseOrderSave('reject')" size="mini">驳回</el-button>
          <el-button type="primary" @click="beginPurchaseOrderSave('pass')" size="mini">通过</el-button>
        </template>
      </rg-dialog>
    </section>
    <!-- 审核驳回采购任务 -->
      ...
      >
        <template v-slot:content>
          <el-form :model="formModel" :rules="rules" ref="formModel">
            <el-row>
              <el-col :span="17">
                <el-form-item label="目标仓库" prop="warehouseName" :label-width="formLabelWidth">
                  <el-select
            ...
            <el-row>
              <el-col :span="17">
                <el-form-item label="产品编号" prop="productId" :label-width="formLabelWidth">
                  <el-input v-model="formModel.productId" placeholder="请输入产品编号"    style="width:100%;"/>
                </el-form-item>
            ...
            <el-row>
              <el-col :span="17">
                <el-form-item label="预计到货时间" prop="planInstockDate" :label-width="formLabelWidth">
                  <el-col>
                    <el-date-picker
            ...
            <el-row>
              <el-col :span="17">
                <el-form-item label="采购数量" prop="num" :label-width="formLabelWidth">
                  <el-input
            ...
            <el-row>
              <el-col :span="17">
                <el-form-item label="采购单价" prop="purchasePrice" :label-width="formLabelWidth">
                  <el-input
                    oninput="value=value.replace(/[^\d.]/g,'')"
            ...
            <el-row>
              <el-col :span="17">
                <el-form-item label="采购总价" :label-width="formLabelWidth">
                  <el-input readonly v-model="formModel.totalPrice"   style="width:100%;"/>
                </el-form-item>
            ...
            <el-row>
              <el-col :span="17">
                <el-form-item label="成本单价" :label-width="formLabelWidth">
                  <el-input readonly v-model="formModel.costPrice"   style="width:100%;"/>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="17">
                <el-form-item label="总成本" :label-width="formLabelWidth">
                  <el-input readonly v-model="formModel.totalCost"  style="width:100%;" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="17">
                <el-form-item label="提货方式" prop="shipmentType" :label-width="formLabelWidth">
                  <el-select
            ...
            <el-row>
              <el-col :span="17">
                <!-- 账期 -->
                <el-form-item label="账期" prop="accountPeriod" :label-width="formLabelWidth">
                  <el-select
            ...
            <el-row>
              <el-col :span="17">
                <el-form-item label="税点" :label-width="formLabelWidth">
                  <el-input v-model="formModel.taxPoint" readonly   style="width:100%;"/>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
    ...
    <section id="switchWarehouse">
      <rg-dialog
        ...
        v-if="switchWarehouseFormVisible"
        :beforeClose="switchWarehouseCancel"
        :btnCancel="{label:'关闭',click:(done)=>{switchWarehouseCancel('formModel')}}"
        :btnRemove="false"
        :footbar="true"
        width="78%"
        maxWidth="800px"
      ...
      >
        <template v-slot:content>
          <el-form :model="switchWarehouseFormModel" ref="switchWarehouseFormModel">
            ...
            <el-form-item label="备注" size="50" :label-width="formLabelWidth">
              <el-input
                type="textarea"
                :rows="5"
                placeholder="请输入备注"
        ...
        <template v-slot:footer>
          <el-button type="warning" @click="switchWarehouseSave()" size="mini">转仓</el-button>
        </template>
      </rg-dialog>
    </section>
    <!-- 转仓页面 -->
    ...
    <section id="viewswitchWarehouse">
      <rg-dialog
        ...
        v-if="viewswitchWarehouseFormVisible"
        :beforeClose="viewswitchWarehouseCancel"
        :btnCancel="{label:'关闭',click:(done)=>{viewswitchWarehouseCancel('formModel')}}"
        :btnRemove="false"
        :footbar="true"
        width="78%"
        maxWidth="800px"
