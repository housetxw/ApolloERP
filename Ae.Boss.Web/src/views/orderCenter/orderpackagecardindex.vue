    ...
    <section>
      ...
      >
        ...
        <template v-slot:tb_cols>
          ...
          <rg-table-column label="备注" prop="remark" width="200" />
          <rg-table-column
            prop="name"
            label="操作"
            fixed="right"
            ...
            <template slot-scope="scope">
              <el-button-group>
                <el-button
                  ...
                  :disabled="scope.row.status != '已使用' &&  scope.row.status != '作废'? false : true"
                  >修改</el-button
                >
                <el-button
                  size="mini"
                ...
                <el-button
                  ...
                  :disabled="scope.row.status == '未使用' || scope.row.status == '已过期' ? false : true"
                  >作废</el-button
                >
              </el-button-group>
            </template>
...
export default {
  ...
  methods: {
    ...
    cancelData(value) {
      ...
      this.$confirm(value.code+",确定要作废该核销码？", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      })
