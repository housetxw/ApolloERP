...
import {
  GetEmpAuthorityListForWebByEmpIdAsync
} from '@/api/user/user'
...
const actions = {
  async generateRoutes({
    ...
    let PermissionRouters = await GetEmpAuthorityListForWebByEmpIdAsync({
      ...
      const subMenu = res.data.subMenu
      let myTopMenu = filterFirstMenu(topMenu, clientRoutes)
      const data = myTopMenu.concat(subMenu)
