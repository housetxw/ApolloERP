...
namespace Ae.Shop.Api.Common.Extension
{
    public static class DateTimeExtension
    {
        ...
        public static List<DateTime> GetThirtyDayDateTimeList(this DateTime value)
        {
            var res = new List<DateTime>(CommonConstant.Thirty);

            for (var i = 0; i < CommonConstant.Thirty; i++)
            {
                ...
                res.Add(value.AddDays(-i));
            }

            return res;
        }

        public static List<DateTime> GetSpecificDaysDateTimeList(this DateTime value, int days = 29)
        {
            var res = new List<DateTime>(days + 1);
