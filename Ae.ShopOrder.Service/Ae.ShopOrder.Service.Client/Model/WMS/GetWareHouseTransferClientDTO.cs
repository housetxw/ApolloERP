...
{
    public  class GetWareHouseTransferClientDTO
    {
        /// <summary>
        /// 主键
        /// </summary>
        ...
        /// 产品的信息
        /// </summary>
        public  List<GetWareHouseTransferProductClientDTO> Products { get; set; }

        /// <summary>
        /// 包裹的信息
        /// </summary>
        public List<GetWareHouseTransferPackageClientDTO> Packages { get; set; }
    }
}
