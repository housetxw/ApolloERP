...
using Ae.C.MiniApp.Api.Core.Model.OrderQuery;
using System;
...
namespace Ae.C.MiniApp.Api.Core.Response
{
    ...
    public class GetOrderDetailResponse
    {
        ...
        /// 套餐或单品信息集合
        /// </summary>
        public List<OrderDetailPackageProductVO> Products { get; set; }

        /// <summary>
        /// 服务信息集合
        /// </summary>
        public List<OrderDetailProductVO> Services { get; set; }
        ...
        /// </summary>
        public List<OrderInstallCodeInfoVO> OrderInstallCodeInfos { get; set; }

        /// <summary>
        /// 订单核销码信息集合（现在只返回一个默认的，其他从查看更多获取）
        /// </summary>
        public List<OrderVerificationCodeInfoVO> OrderVerificationCodeInfos { get; set; }
        ...
        /// 推荐商品
        /// </summary>
        public List<CouponProductVo> RecommendProductInfos { get; set; } = null;
