...
{
    public   class GetCouponListByProductClientResponse
    {
        /// <summary>
        /// 可领取的列表
        /// </summary>
        public List<UserCouponListForProductDto> CanReceive { get; set; }

        /// <summary>
        ///  已领取的列表
        /// </summary>
        public List<UserCouponListForProductDto> HasReceive { get; set; }
    }

    /// <summary>
    /// UserCouponListForProduct
    /// </summary>
    public class UserCouponListForProductDto
    {
        /// <summary>
        /// 活动Id
        /// </summary>
