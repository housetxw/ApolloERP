...
namespace Ae.C.MiniApp.Api.Client.Model.Activity
{
    public class PromoteContentDTO
    {
        /// <summary>
        /// 主键
        /// </summary>
        ...
        /// 附件
        /// </summary>
        public List<PromoteContentAttachmentDTO> Attachments { get; set; } = new List<PromoteContentAttachmentDTO>();
    }
}
