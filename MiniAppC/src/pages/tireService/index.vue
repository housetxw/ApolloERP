      ...
      <div class="bottom_box">
        ...
        <div class="byservice" @tap="serviceClick(item1,index1)">
          ...
          <div class="byservice_right">
            <img :src="item1.isDefaultExpand?'https://m.aerp.com.cn/mini-RG-main/maintenance_radio_click.png':'https://m.aerp.com.cn/mini-RG-main/maintenance_radio.png'" alt />
          </div>
        </div>
        <!-- 根据爱车推荐  更换规格 -->
          ...
          <div :class="[{'border_style': item2.isDefaultSelect?true:false} , 'top_title']" v-for="(item2,index2) in item1.products" :key="index2">
            ...
            <div style="position:relative;display:flex;flex-direction:row;width:520rpx;">
              ...
              <div class="selectedImg" @tap="item2Click(item1,index1,item2,index2)">
                <img :src="item2.isDefaultSelect?'https://m.aerp.com.cn/mini-RG-main/maintenance_radio_click.png':'https://m.aerp.com.cn/mini-RG-main/maintenance_radio.png'" alt class="img" />
              </div>
            </div>
          </div>
