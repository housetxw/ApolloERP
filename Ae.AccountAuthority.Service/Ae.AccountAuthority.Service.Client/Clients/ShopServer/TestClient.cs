using Ae.AccountAuthority.Service.Client.Request;
using Ae.AccountAuthority.Service.Client.Response;
...
namespace Ae.AccountAuthority.Service.Client.Clients.ShopServer
{
