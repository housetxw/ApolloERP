...
namespace Ae.Receive.Service.Core.Response.ReceiveCheck
{
    ...
    public class CheckReportResponse
    {
        ...
        /// 主数据
        /// </summary>
        public CheckReportMainData MainData { get; set; }
        ...
        /// 检查结果
        /// </summary>
        public List<CheckResultClassify> Items { get; set; }
    }

    /// <summary>
    /// 检查报告主数据
    /// </summary>
    public class CheckReportMainData
    {
        /// <summary>
        /// 检查记录Id
        /// </summary>
        ...
        /// 质检签字
        /// </summary>
        public string ZhiJianSignature { get; set; }
    }

    /// <summary>
    /// 检查结果分类
    /// </summary>
    public class CheckResultClassify
    {
        /// <summary>
        /// 结果词Code
        /// </summary>
        ...
        /// 检查大类
        /// </summary>
        public List<CheckClassfy> CheckClassfy { get; set; }
    }

    /// <summary>
    /// 检查大类
    /// </summary>
    public class CheckClassfy
    {
        /// <summary>
        /// 分类名称：内饰 外观  发动机舱……
        /// </summary>
        ...
        /// 具体检查项
        /// </summary>
        public List<CheckResultItem> ResultItems { get; set; }
    }
