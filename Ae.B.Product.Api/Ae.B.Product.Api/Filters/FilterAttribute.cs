    ...
    public class FilterAttribute : TypeFilterAttribute
    {
        ...
        private class FilterImpl : IAsyncActionFilter, IAsyncExceptionFilter
        {
            ...
            public async Task OnExceptionAsync(ExceptionContext context)
            {
                ...
                {
                    context.Result = new ObjectResult(Result.Exception($"{context.ActionDescriptor.RouteValues["controller"]} {context.ActionDescriptor.RouteValues["action"]} Exception{context.Exception.Message}"));
